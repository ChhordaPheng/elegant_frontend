        ...
        <v-container fluid class="pa-0 mt-[60px]">
          <v-row no-gutters>
            ...
            <v-col cols="3" class="pa-3 pl-12" style="min-height: 100vh">
              ...
              <div class="flex justify-between items-center border-b-2 my-5">
                <p class="uppercase font-bold text-[25px]">{{ $t("content.brand") }}</p>
                <v-btn
                  variant="text"
                  class="uppercase !font-bold text-[15px] text-gray-500"
                  @click="resetBrands"
              ...
              <div class="border-b-2 my-5">
                <p class="uppercase font-bold text-[25px]">{{ $t("content.trending_product") }}</p>
              </div>
              <div
                ...
                <v-container class="pa-0 pr-12">
                  <v-row>
                    <v-col>
                      <div class="pl-3 mt-1">
                        <p>
                          {{ $t("content.clothing") }} ({{ men?.length || 0 }}
                          items)
                        </p>
        ...
        <v-navigation-drawer v-model="drawer" temporary app>
          <v-container>
            <div class="pa-4" style="min-height: 100vh">
              ...
              <!-- Price Filter -->
              <div class="flex justify-between items-center border-b-2">
                <p class="uppercase font-bold text-[25px]">{{ $t("content.price") }}</p>
                <v-btn
                  variant="text"
                  class="uppercase !font-bold text-[15px] text-gray-500"
                  @click="resetPrice"
              ...
              <div class="my-10">
                ...
                ></v-range-slider>
                <div class="mt-2 font-weight-medium">
                  <span class="text-gray-600 mr-2">{{ $t("content.range") }} :</span>
                  <span class="text-black font-weight-bold">
                    ${{ priceRange[0] }} - ${{ priceRange[1] }}
                  </span>
                </div>
              ...
              <div class="flex justify-between items-center border-b-2 my-5">
                <p class="uppercase font-bold text-[25px]">{{ $t("content.color") }}</p>
                <v-btn
                  variant="text"
                  class="uppercase !font-bold text-[15px] text-gray-500"
                  @click="resetColor"
              ...
              <div class="flex justify-between items-center border-b-2 my-5">
                <p class="uppercase font-bold text-[25px]">{{ $t("content.brand") }}s</p>
                <v-btn
                  variant="text"
                  class="uppercase !font-bold text-[15px] text-gray-500"
                  @click="resetBrands"
